Pod::Spec.new do |s|
  ...
  s.vendored_frameworks = 'Tude.xcframework', 'OMSDK_Prebidorg.xcframework', 'PrebidMobile.xcframework'
  s.preserve_paths =  'Tude.xcframework/*', 'OMSDK_Prebidorg.xcframework/*', 'PrebidMobile.xcframework/*'
